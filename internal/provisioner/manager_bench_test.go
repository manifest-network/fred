...
func (m *mockBenchBackend) Restore(ctx context.Context, req backend.RestoreRequest) error {
...
func (m *mockBenchBackend) GetLoadStats(_ context.Context) (*backend.LoadStats, error) {
	return nil, nil
}
